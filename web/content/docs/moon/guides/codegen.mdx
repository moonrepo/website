...
Every template requires a [`template.config`][config] file in the template's directory root. This file
...
[config]: /api/moon/TemplateConfig
[command]: ../commands/generate.mdx
[gen-templates]: /api/moon/GeneratorConfig#templates
