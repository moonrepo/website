...
- [Generating code](./generator/index.mdx), documentation, and other formats.
...
[`SchemaType`][schematype], and [associated types](./types.mdx). If you want these types to use
...
<Callout>Learn more about our [supported types](./types.mdx).</Callout>
...
Learn more about [renderers](./generator/index.mdx).
...
Learn more about [external types](./external.mdx).
