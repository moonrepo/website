...
[generator](./generator/index.mdx), which can then generate and render the schema types in a variety
of formats.

- [Arrays](./array.mdx)
- [Booleans](./boolean.mdx)
- [Enums](./enum.mdx)
- [Floats](./float.mdx)
- [Integers](./integer.mdx)
- [Literals](./literal.mdx)
- [Nulls](./null.mdx)
- [Objects](./object.mdx)
- [Strings](./string.mdx)
- [Structs](./struct.mdx)
...
<Callout>
  This method is optional, but is encouraged for non-primitive types. It will
  associate references between types, and avoid circular references.
</Callout>
