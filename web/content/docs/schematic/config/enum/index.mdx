---
title: Unit-only enums
icon: List
---

Configurations typically use enums to support multiple values within a specific
[setting](../settings.mdx). To simplify this process, and to provide streamlined interoperability
...
- `fallback` - Marks the variant as the [fallback](./fallback.mdx).
