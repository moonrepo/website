...
<Callout>
Refer to the [default values](./struct/default.mdx), [merge strategies](./struct/merge.mdx), and
[validation rules](./struct/validate.mdx) sections for more information on how to use context.
</Callout>
...
<Callout>
A key derived from an [`env_prefix`](./struct/env.mdx#container-prefixes) is reported with the
