...
<Callout>
  We provide a handful of built-in merge functions in the [`merge`
  module](https://docs.rs/schematic/latest/schematic/merge/index.html).
</Callout>
...
[context](../context.mdx) are passed as arguments, and the function must return an optional merged
