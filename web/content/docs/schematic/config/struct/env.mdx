...
<Callout>
Requires the `env` Cargo feature, which is enabled by default. Not supported for enums.
</Callout>
...
[schema](../../schema/index.mdx). A derived key appears in a generated
[config template](../../schema/generator/template.mdx) and in
